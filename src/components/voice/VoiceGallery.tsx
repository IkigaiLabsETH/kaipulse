    ...
    >
      <div className="min-h-screen flex flex-col bg-black relative overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-gradient-to-b from-black via-slate-900/90 to-yellow-950/20 opacity-80" />
          <div className="absolute top-0 left-0 w-full h-full flex">
            <div className="absolute top-0 h-1 w-[80%] mx-auto left-[10%] bg-gradient-to-r from-transparent via-yellow-500/30 to-transparent" />
            <div className="absolute bottom-0 h-1 w-[80%] mx-auto left-[10%] bg-gradient-to-r from-transparent via-yellow-500/30 to-transparent" />
            <div className="absolute left-0 w-1 h-[80%] my-auto top-[10%] bg-gradient-to-b from-transparent via-yellow-500/30 to-transparent" />
            <div className="absolute right-0 w-1 h-[80%] my-auto top-[10%] bg-gradient-to-b from-transparent via-yellow-500/30 to-transparent" />
          </div>
        ...
        <motion.header 
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          className="relative z-10 py-8 px-6 flex items-center justify-between"
        >
          <div>
            <h1 className="font-satoshi text-3xl font-light tracking-wider text-yellow-500/90 uppercase">
              <span className="font-bold">Voice</span> Gallery
            </h1>
            <p className="text-yellow-500/60 text-sm mt-1 font-light max-w-md">
              A sonic experience curated by artificial intelligence
            </p>
          </div>
            ...
            <button 
              ...
              className={`px-3 py-1 border rounded-full text-sm transition-all ${
                currentView === 'dialogue' 
                  ? 'border-yellow-500/60 text-yellow-500 bg-yellow-500/10' 
                  : 'border-yellow-500/20 text-yellow-500/60 hover:bg-yellow-500/5'
              }`}
            >
              Dialogue
            </button>
            ...
            {currentView === 'dialogue' ? (
              ...
              >
                ...
                {messages.length === 0 && (
                  ...
                  >
                    <h2 className="text-yellow-500/90 text-xl font-light mb-4">
                      Welcome to the <span className="font-bold">Conversational Arts Exhibition</span>
                    </h2>
                    <p className="text-yellow-500/70 mb-2">
                ...
                {/* Chat Messages */}
                <div className="w-full flex-1 overflow-hidden mb-8">
              ...
              >
                <div className="w-full max-w-2xl mx-auto">
                  <div className="border border-yellow-500/10 rounded-xl p-6 bg-black/40 backdrop-blur-lg overflow-hidden">
                    <div className="mb-6">
                      <h3 className="text-yellow-500/90 text-lg font-light mb-2">Voice Spectrum</h3>
                      <p className="text-yellow-500/50 text-sm">
                        An artistic visualization of your audio input, rendered in real-time
                      </p>
                    </div>
                    <div className="aspect-[16/9] bg-black/60 rounded-lg flex items-center justify-center overflow-hidden relative">
        ...
        <motion.div 
          ...
          className="relative z-10 mt-auto py-8 px-6"
        >
          <div className="max-w-2xl mx-auto">
            <div className="backdrop-blur-lg bg-black/40 border border-yellow-500/10 rounded-xl p-6">
              <div className="flex flex-col md:flex-row items-center gap-6 md:gap-10">
                <div className="flex-1 flex flex-col items-center md:items-start gap-4">
                  <div className="font-light tracking-wider text-yellow-500/70 text-sm">
                ...
                <div className="w-full md:w-auto">
                  <Button
                    variant="outline"
                    size="lg"
                    className="w-full md:w-auto bg-black hover:bg-yellow-950/30 text-yellow-500 border border-yellow-500/30 hover:border-yellow-500/50 h-12 px-6 transition-all duration-300"
                    onClick={handleEndCall}
                  >
                    Leave Exhibition
                  </Button>
        ...
        >
          <p className="text-yellow-500/40 text-xs">MSTY Voice Gallery • Powered by Hume AI</p>
        </motion.div>
      </div>
    </VoiceProvider>
  );
