    ...
    <div className="relative">
      ...
      >
        <Button
          variant="solid"
          color="yellow"
          className="px-8 py-4 text-lg bg-gradient-to-r from-yellow-500 to-yellow-400 hover:from-yellow-400 hover:to-yellow-500 text-black font-medium shadow-[0_0_20px_rgba(234,179,8,0.2)] hover:shadow-[0_0_30px_rgba(234,179,8,0.3)] transition-all duration-300 rounded-sm flex items-center gap-3"
