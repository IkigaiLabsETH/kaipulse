...
export default function StrikeStats() {
  ...
  return (
    <section ref={ref} className="py-8 sm:py-10 md:py-16 px-2 sm:px-4 bg-transparent">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6 max-w-5xl mx-auto">
        {stats.map((stat, index) => (
          ...
          >
            <Card className="flex flex-col items-center justify-center border-2 border-yellow-500 shadow-[5px_5px_0px_0px_rgba(234,179,8,1)] bg-[#1c1f26] text-white p-3 sm:p-4 md:p-6 mb-0">
              <div className="text-lg sm:text-xl md:text-2xl font-bold mb-1 text-yellow-500">
                {stat.value}
              </div>
