      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 pt-20 sm:pt-24 pb-10 sm:pb-16">
        <div className="space-y-10 sm:space-y-16">
          ...
          <div className="text-center space-y-6 sm:space-y-8">
            <p className="uppercase tracking-[0.4em] text-yellow-500/90 text-xs sm:text-sm mb-2 sm:mb-4 font-light font-satoshi">Analysis • Cycle Theory • Power Law</p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center mt-4 sm:mt-6 gap-2 sm:gap-0">
              ...
              <p className="mx-0 sm:mx-6 text-base sm:text-lg text-white/70 font-light italic font-satoshi">Understanding Bitcoin&apos;s Market Cycles</p>
              <div className="h-px w-16 sm:w-24 bg-yellow-500/30"></div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            {/* Power Law Support */}
            <div className="bg-[#1c1f26] rounded-none border-2 border-yellow-500 shadow-[5px_5px_0px_0px_rgba(234,179,8,1)] p-6">
              ...
              <div className="bg-yellow-500/10 p-4 rounded-lg">
                <h4 className="text-sm text-yellow-400 mb-2">Key Support Levels</h4>
            ...
            <div className="bg-[#1c1f26] rounded-none border-2 border-yellow-500 shadow-[5px_5px_0px_0px_rgba(234,179,8,1)] p-6">
              ...
              <div className="bg-yellow-500/10 p-4 rounded-lg">
                <h4 className="text-sm text-yellow-400 mb-2">2024-25 Cycle</h4>
                <ul className="space-y-2 text-gray-300">
              ...
              <div className="bg-yellow-500/10 p-4 rounded-lg mt-4">
                <h4 className="text-sm text-yellow-400 mb-2">2028-30 Cycle</h4>
                <ul className="space-y-2 text-gray-300">
            ...
            <div className="bg-[#1c1f26] rounded-none border-2 border-yellow-500 shadow-[5px_5px_0px_0px_rgba(234,179,8,1)] p-6">
              ...
              <div className="bg-yellow-500/10 p-4 rounded-lg">
                <h4 className="text-sm text-yellow-400 mb-2">Strategy Guidelines</h4>
                <ul className="space-y-2 text-gray-300">
            ...
            <div className="bg-[#1c1f26] rounded-none border-2 border-yellow-500 shadow-[5px_5px_0px_0px_rgba(234,179,8,1)] p-6">
              ...
              <div className="bg-yellow-500/10 p-4 rounded-lg">
                <h4 className="text-sm text-yellow-400 mb-2">Current Cycle</h4>
                <ul className="space-y-2 text-gray-300">
              ...
              <div className="bg-yellow-500/10 p-4 rounded-lg mt-4">
                <h4 className="text-sm text-yellow-400 mb-2">Invalidation Levels</h4>
                <ul className="space-y-2 text-gray-300">
          ...
          {/* Conclusion */}
          <div className="bg-[#1c1f26] rounded-none border-2 border-yellow-500 shadow-[5px_5px_0px_0px_rgba(234,179,8,1)] p-8">
