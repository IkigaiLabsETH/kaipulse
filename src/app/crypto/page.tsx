      ...
      <div className="container mx-auto px-2 sm:px-4 py-12 sm:py-24">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <AltcoinInfoCard id="hyperliquid" />
            <AltcoinInfoCard id="render-token" />
            <AltcoinInfoCard id="kaia" />
            <AltcoinInfoCard id="aave" />
            <AltcoinInfoCard id="injective-protocol" />
            <AltcoinInfoCard id="sei-network" />
            <AltcoinInfoCard id="spx6900" />
            <AltcoinInfoCard id="dogwifcoin" />
          ...
          <div className="w-full max-w-[90rem] mx-auto flex flex-col sm:flex-row flex-wrap justify-center gap-4 sm:gap-8 mt-8 sm:mt-12 mb-8 sm:mb-12">
            ...
            <CardContent className="p-4 sm:p-10 md:p-14">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 sm:mb-8">
                ...
                <Coins className="h-8 w-8 sm:h-10 sm:w-10 text-yellow-500" />
              </div>
              <div className="space-y-6 sm:space-y-8 text-white/90">
                ...
                <p className="text-base sm:text-lg md:text-xl font-satoshi mt-4 sm:mt-6">
