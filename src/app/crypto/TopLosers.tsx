...
export default function TopLosers() {
  ...
  return (
    <div className="my-8 sm:my-12">
      <h2 className="text-2xl sm:text-3xl font-bold text-yellow-500 mb-6 sm:mb-8 text-center font-epilogue tracking-tight">DOWN BAD (24h)</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
        {coins.map((coin) => (
          ...
          >
            ...
            <div className="text-red-500 font-bold text-sm sm:text-base font-satoshi">{coin.price_change_percentage_24h.toFixed(2)}%</div>
          </div>
        ))}
      </div>
    </div>
