        ...
        <div className="space-y-16">
          ...
          <div className="bg-[#1c1f26] p-8 rounded-none border-2 border-yellow-500 shadow-[5px_5px_0px_0px_rgba(234,179,8,1)]">
            ...
            <div className="space-y-4 text-gray-300">
              <p className="text-lg">
                Each generation&apos;s favored asset class has seen distinct boom–bust cycles. Gold exploded during 1970s inflation – reaching a record high of about $850/oz in January 1980 – before slumping thereafter. The S&P 500 enjoyed a multi-decade bull market, while the Nasdaq-100 (QQQ ETF) rallied from about $100 in 2000 to over $500 by 2025.
              </p>
              <p className="text-lg">
                Bitcoin, launched in 2009, was essentially worthless initially, then skyrocketed to roughly $20,000 in late 2017 and to about $46,000 by end-2021, before falling back and partially recovering to ~$42K by end-2023.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-[#1c1f26] p-8 rounded-none border-2 border-yellow-500 shadow-[5px_5px_0px_0px_rgba(234,179,8,1)]">
              ...
              <div className="space-y-4 text-gray-300">
                <p className="text-lg">
                  Silent Generation (born ~1928–1945) valued safe, tangible assets like gold, especially during the inflationary 1970s. Baby Boomers (born ~1946–1964) benefited from postwar growth and financial deregulation, heavily investing in equities and consumer stocks.
                </p>
              </div>
            </div>
            <div className="bg-[#1c1f26] p-8 rounded-none border-2 border-yellow-500 shadow-[5px_5px_0px_0px_rgba(234,179,8,1)]">
              ...
              <div className="space-y-4 text-gray-300">
                <p className="text-lg">
                  Gen X (born ~1965–1980) embraced tech stocks during the Internet boom. Millennials (born ~1981–1996) witnessed the 2008 crisis and are digital natives, showing strong affinity for cryptocurrencies and fintech solutions.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#1c1f26] p-8 rounded-none border-2 border-yellow-500 shadow-[5px_5px_0px_0px_rgba(234,179,8,1)]">
            ...
            <div className="space-y-4 text-gray-300">
              <p className="text-lg">
                As of 2022, Americans held roughly $156 trillion in assets, with Baby Boomers controlling about half (~$78.1T). A massive intergenerational transfer is expected, with Knight Frank projecting up to $90 trillion passing to younger generations by 2044.
              </p>
            </div>
          </div>
