...
export default function AIContent() {
  return (
    ...
    >
      ...
      <SparkleBG />
      <div className="relative max-w-4xl mx-auto px-6 py-28 z-20">
        <div className="relative flex flex-col items-start justify-center pt-10 md:pt-16 mt-8 md:mt-14"></div>
        {/* Hero Section */}
        <motion.div
