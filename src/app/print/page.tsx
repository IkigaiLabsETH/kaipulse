      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
        <div className="space-y-16">
          ...
          <div className="text-center space-y-8">
            <p className="uppercase tracking-[0.4em] text-yellow-500/90 text-sm mb-4 font-light font-satoshi">Artistic Philosophy • Manifesto</p>
          ...
          <div className="bg-[#1c1f26] p-8 rounded-none border-2 border-yellow-500 shadow-[5px_5px_0px_0px_rgba(234,179,8,1)]">
            ...
            <div className="space-y-6 text-gray-300">
              ...
              <p className="text-lg">
                We are not onboarding the masses. We are not feeding the feed.
                We are building sanctuaries—for those who still care.
              </p>
              <p className="text-lg">
                We don&apos;t collect JPEGs. We collect transference.
              </p>
              <p className="text-lg font-semibold text-yellow-500">
                This is the post-digital renaissance.
                This is the LTL standard.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#1c1f26] p-8 rounded-none border-2 border-yellow-500 shadow-[5px_5px_0px_0px_rgba(234,179,8,1)]">
            ...
            <div className="space-y-6 text-gray-300">
              ...
              <div className="mt-8">
                <h4 className="text-xl font-bold text-yellow-500 mb-4">We believe:</h4>
                <ul className="list-disc list-inside space-y-2">
                  <li>Provenance is digital. Experience is physical.</li>
                  <li>Great art transmits presence, not resolution.</li>
                  <li>The masses will come later. First, we build for the few who care.</li>
                </ul>
              </div>
              ...
              <p className="text-lg font-semibold text-yellow-500 mt-8">
                This is LTL.
                This is the new standard.
                Welcome to the post-digital renaissance.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#1c1f26] p-8 rounded-none border-2 border-yellow-500 shadow-[5px_5px_0px_0px_rgba(234,179,8,1)]">
            ...
            <div className="space-y-6 text-gray-300">
              ...
              <div className="mt-8">
                <h4 className="text-xl font-bold text-yellow-500 mb-4">In collaboration with our partners at Transient Labs, we are embedding each work with:</h4>
                <ul className="list-disc list-inside space-y-2">
                  <li>A secure, tamper-evident chip</li>
                  <li>A digital certificate of authenticity minted on-chain</li>
                  <li>A physical print of museum quality, signed by the artist</li>
                </ul>
              </div>
              <p className="text-lg mt-8">
          ...
          <div className="bg-[#1c1f26] p-8 rounded-none border-2 border-yellow-500 shadow-[5px_5px_0px_0px_rgba(234,179,8,1)]">
            ...
            <div className="space-y-6 text-gray-300">
              <p className="text-lg">
                The post-digital renaissance isn&apos;t coming. It&apos;s already here.
                We&apos;re not asking if art can survive in a hybrid world. We&apos;re proving that it thrives there.
              </p>
              <p className="text-lg">
                LTL is not a marketplace.
                We are restoring presence. Preserving truth. And preparing the foundation for the next 100 years of collecting.
              </p>
              <p className="text-lg font-semibold text-yellow-500">
                This is art you feel.
                This is art you trust.
                This is art that remembers.
              </p>
              <p className="text-lg font-bold text-yellow-500 mt-8">
                This is LTL.
              </p>
            </div>
          </div>
