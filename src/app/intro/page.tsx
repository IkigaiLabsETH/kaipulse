    ...
    <div className="min-h-screen bg-black text-white font-satoshi">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
        <div className="space-y-16">
          ...
          <details className="bg-[#1c1f26] rounded-none border-2 border-yellow-500 shadow-[5px_5px_0px_0px_rgba(234,179,8,1)] group">
            <summary className="p-8 cursor-pointer list-none">
              <h3 className="text-2xl md:text-3xl font-bold text-yellow-500 mb-6 flex items-center justify-between">
                <span>🚀 Bitcoin Strategy</span>
          ...
          {/* DeFi & Web3 Section */}
          <details className="bg-[#1c1f26] rounded-none border-2 border-yellow-500 shadow-[5px_5px_0px_0px_rgba(234,179,8,1)] group mt-8">
            <summary className="p-8 cursor-pointer list-none">
              <h3 className="text-2xl md:text-3xl font-bold text-yellow-500 mb-6 flex items-center justify-between">
                <span>💡 DeFi & Web3</span>
                <span className="transform group-open:rotate-180 transition-transform duration-200">▼</span>
