...
const LoadingFallback = () => (
  <div className="min-h-screen flex flex-col items-center justify-center bg-[#1c1f26] text-white overflow-hidden">
    ...
    >
      <p className="uppercase tracking-[0.4em] text-yellow-500 text-sm mb-4 font-light font-satoshi">Voice Call</p>
...
function VoiceExperience() {
  ...
  if (error || !accessToken) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#1c1f26]">
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="text-yellow-500 text-center max-w-md px-8 py-12 bg-[#1c1f26] rounded-none border-2 border-yellow-500 shadow-[5px_5px_0px_0px_rgba(234,179,8,1)]"
        >
  ...
  return (
    ...
    >
      <div className="min-h-screen flex flex-col bg-[#1c1f26] relative overflow-hidden">
        ...
        >
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <p className="uppercase tracking-[0.4em] text-yellow-500 text-sm mb-4 font-light font-satoshi">Audio Experience</p>
              <h1 className="text-center">
                <span className="text-5xl md:text-6xl font-bold text-yellow-500 tracking-tight [text-shadow:_0_1px_20px_rgba(234,179,8,0.3)] font-epilogue">
                  Voice Call
                </span>
              </h1>
